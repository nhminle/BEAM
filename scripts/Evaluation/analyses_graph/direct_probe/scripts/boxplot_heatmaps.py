...
DATA_BASE_DIR = 'results/direct_probe'
...
def main():
   ...
   # Create the boxplot with transparency
    ...
    sns.stripplot(
        ...
        dodge=False, marker="o", alpha=0.5, jitter=True, linewidth=0
    )


    plt.xlabel("Language Group", fontsize=14)
    plt.ylabel("Accuracy (%)", fontsize=14)
    plt.title("Direct Probing Performance Across Language Group", fontsize=16)
...
# Remove duplicate legend entries
    ...
    # Save the plot
    plot_filename = "direct_probing_boxplot.png"
