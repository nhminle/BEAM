...
def main(title):
    df1 = pd.read_csv(f'/Users/minhle/Umass/ersp/Evaluation/llm_out/name_cloze/{title}.csv')
    df = pd.DataFrame()
    ...
    for model in models:
        if model in title:
            df.to_csv(f'/Users/minhle/Umass/ersp/Evaluation/eval/csv/{model}/{title}.csv', index=False, encoding='utf-8')
            df_shuffled.to_csv(f'/Users/minhle/Umass/ersp/Evaluation/eval/csv/{model}/shuffled/{title}_shuffled.csv', index=False, encoding='utf-8')
    ...
    plt.ylim(0, 100)
    plt.savefig(f'/Users/minhle/Umass/ersp/Evaluation/eval/plots/{title}.png', dpi=300, bbox_inches='tight')
    # plt.show()
...
titles = list_csv_files('/Users/minhle/Umass/ersp/Evaluation/llm_out/name_cloze')
